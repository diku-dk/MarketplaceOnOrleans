...
public class BloggingContextFactory : IDesignTimeDbContextFactory<SellerDbContext>
{
    public SellerDbContext CreateDbContext(string[] args)
    {
        ...
        config.AdoNetConnectionString = "Host=postgres;Port=5432;Database=ucloud;Username=ucloud;Password=ucloud;Pooling=true;Minimum Pool Size=0;Maximum Pool Size=10000";
