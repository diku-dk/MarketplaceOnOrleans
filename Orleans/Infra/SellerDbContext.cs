...
namespace SellerMS.Infra
{
    public class SellerDbContext : DbContext
    {
        ...
        public static readonly string OrderSellerViewSql = $"CREATE MATERIALIZED VIEW IF NOT EXISTS public.{nameof(OrderSellerView)} " +
        ...
        public const string OrderSellerViewSqlIndex = $"CREATE UNIQUE INDEX IF NOT EXISTS order_seller_index ON public.{nameof(OrderSellerView)} (seller_id)";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderEntry>(e =>
            {
                ...
                // e.HasIndex(oe => oe.seller_id, "order_entry_seller_idx");
