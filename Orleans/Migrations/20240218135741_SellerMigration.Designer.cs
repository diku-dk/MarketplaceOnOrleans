...
namespace Orleans.Migrations
{
    ...
    [Migration("20240218135741_SellerMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Entities.OrderEntry", b =>
                {
                    b.Property<int>("db_pk")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("db_pk"));
                    ...
                    b.HasIndex("customer_id", "order_id", "product_id", "seller_id")
                        .IsUnique();
